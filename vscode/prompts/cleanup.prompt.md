---
description: "Cleanup agent — inventories the repo, removes loose threads and stale artifacts, refactors hardcoded values, connects disconnected code. Behavior-preserving."
agent: agent
---
