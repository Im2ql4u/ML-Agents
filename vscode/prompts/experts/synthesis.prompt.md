---
description: "Association and fusion expert. Merges conflicting or complementary signals from multiple experts or modes into one coherent recommendation."
agent: agent
---

${input:signals:Paste the outputs, findings, or conflicting signals that need synthesis.}
